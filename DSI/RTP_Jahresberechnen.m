...
function [lastgang, lastgang_ohnePV] = RTP_Jahresberechnen(handles, tarifprofil, lastgang_normal)
%RTP_JAHRESBERECHNEN Summary of this function goes here
%   Detailed explanation goes here
%  if sum(lastgang.waschmaschine)==0
     
 struct_sp = startpunkt_rtp(tarifprofil, lastgang_normal, handles);
